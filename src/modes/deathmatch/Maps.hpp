...
inline const std::vector<Map> MAPS
	= { Map { "Warehouse", WeaponSet::Value::Custom,
		  ...
		  Map { "LVPD", WeaponSet::Value::Walk,
			  ...
			  3 },
		  Map { "Las Payasadas", WeaponSet::Value::Walk,
		  ...
		  Map { "Farm", WeaponSet::Value::Walk,
			  ...
			  0 },
		  Map { "Ghost Town", WeaponSet::Value::Walk,
			  ...
			  0 },
		  Map { "Giant Bridge", WeaponSet::Value::Walk,
